...
echo -e "            _____   __  ___   _____      _____   _   _       _____  "
echo -e "           |  ___|  \ \/  /  |  ___|    | ____| | | | |     |  ___| "
echo -e "           | |___    \   /   | |___     | |___  | | | |     | |___  "
echo -e "           |  ___|    | |    |  ___|    |  ___| | | | |     |  ___| "
echo -e "           | |___     | |    | |___     | |     | | | |___  | |___  "
echo -e "  By:P36R0 |_____|    |_|    |_____|    |_|     |_| |_____| |_____| "
...
verificar_subdominios_com_extensao() {
    ...
    while IFS= read -r subdomain; do
        ...
        elif [ -n "$http_status" ] && [ $http_status -eq 301 ]; then
